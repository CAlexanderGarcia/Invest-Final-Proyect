				...
				<div className="align-start">
					<div className="btn-group dropend">
						<a
							...
							type="a"
							className="contacto btn dropdown-toggle"
						...
						<ul className={"dropdown-menu" + (dropend ? "dropend" : "")}>
							<a className="dropdown-item" href="#">
								<p className="container-fluid d-flex">
									<b>Telefono:</b> 910 000 000 ------ <b>mail:</b> jaf@jaf.com
								</p>
								<p>
									<b>Horario de atención al cliente:</b> 09:00 a 18:00 todos los días
								</p>
							</a>
						</ul>
					</div>
